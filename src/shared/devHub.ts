...
export class DevHubDependencies {
    ...
    public prepareRelatedDependencyOptionsForCurrentDependency(branchNamesThatContainReleasedVersions?: string[], dependencyPackageDisplayName?: string): InquirerOption[] {
